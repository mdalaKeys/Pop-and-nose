...
class HandDetector:
    ...
    def __init__(self, mode=False, maxHands=1, modelComplexity=1, detectionCon=0.5, trackCon=0.5, flipType=False):
        self.mode = mode
    ...
    def fingersUp(self):
        ...
        """
        fingers = []  # Initialize fingers list to avoid UnboundLocalError
        if self.results.multi_hand_landmarks:
